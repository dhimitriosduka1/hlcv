...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption{Occlusion-based attribution for model interpretability on a 74x389 input image using a stride of 8 and a sliding window of 30x30. \textbf{Top}: Untrained DINOv2 model. \textbf{Bottom}: Our DINOv2 model.}

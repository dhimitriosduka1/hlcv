...
def main(config_path, wandb_config_path):
    # Load configuration
    config = load_config(config_path)
    wandb_config = load_config(wandb_config_path)
...
if __name__ == "__main__":
    run_config = "./Project/src/classification/config.yml"
    wandb_config = "./Project/src/classification/wandb.yml" 
    main(run_config, wandb_config)